...
predictions <- predict(
    object = model,
    newdata = test,
    type = "class") #set the prediction type to classification
...
#setwd("D:/Pluralsight")
setwd("E:/청년취업아카데미/2018/[03]Data Science with R/r-data-science/8-r-data-science-m8-exercise-files")
# Save the tree model
save(model, file = "Tree.RData")

#load(file= "Tree.RData")
